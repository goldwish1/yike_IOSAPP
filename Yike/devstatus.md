...
8. [ ] 单元测试完善计划
   - [ ] 核心服务层测试
     - [ ] 完善AudioPlayerService测试（目前使用手动模拟）
       - [ ] 实现完整的MockAVAudioPlayer
       - [ ] 使用方法交换技术拦截AVAudioPlayer的创建
       - [ ] 测试错误处理和边缘情况
     - [ ] 完善SiliconFlowTTSService测试
       - [ ] 模拟API请求和响应
       - [ ] 测试错误处理和重试机制
       - [ ] 测试积分扣除逻辑
     - [ ] OCRService测试实现
   ...
   - [ ] 视图模型测试
     ...
     - [ ] 实现StudyViewModel测试
       ...
       - [ ] 测试统计数据生成
   - [ ] 音频处理测试完善
     - [ ] 完善ApiVoicePlaybackManager测试
       - [ ] 实现网络请求模拟
       - [ ] 测试缓存机制
       - [ ] 测试音频播放回调
     - [ ] 完善LocalVoicePlaybackManager测试
       - [ ] 模拟AVSpeechSynthesizer
       - [ ] 测试语音合成回调
       - [ ] 测试间隔播放逻辑
   - [ ] 测试基础设施优化
     - [ ] 增强TestHelpers功能
